  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Akshita Saini's Portfolio Home Page"
        />
      ...
      <main>
        <header className={styles.header}>
          <div className={styles.headerText}>
            ...
            <div>
              {`I'm `}
              <span className={styles.highlight}>Akshita Saini</span>.
            </div>
            <div>
              {`I'm a `} <span className={styles.darkHighlight}>developer</span>
              !
            </div>
          </div>
        ...
        <section className={styles.sectionTwo}>
          ...
          <div className={styles.socialIcons}>
            <a
              href="https://www.instagram.com/code_with_akshita/"
              target="_blank"
            ...
            <a
              href="https://twitter.com/AkshitaSaini15"
              target="_blank"
              rel="noreferrer noopener"
            >
              <Image
            ...
            <a
              href="https://www.linkedin.com/in/akshita-saini15/"
              target="_blank"
              rel="noreferrer noopener"
            >
              <Image
            ...
            <a
              href="https://github.com/Akshita-Saini/"
              target="_blank"
              rel="noreferrer noopener"
            >
              <Image
